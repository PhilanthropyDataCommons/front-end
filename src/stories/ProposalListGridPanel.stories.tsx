...
const proposals = [
	{
		...
		values: {
			...
			organization_mission_statement: [
				'To create innovative solutions that make the world a better place.',
			],
			organization_start_date: ['2005-03-15'],
			organization_operating_budget: ['$5,000,000'],
			proposal_name: ['Make Things Better'],
			proposal_summary: [
				'Our proposal aims to improve access to clean water in underprivileged communities through the development of a low-cost water filtration system.',
			],
			...
			proposal_location_of_work: [
				'Rural areas in California, Nevada, and Arizona',
			],
		},
	},
	{
		...
		values: {
			...
			proposal_summary: [
				'Our proposal aims to develop a new voting technology that will increase voter participation and improve election security.',
			],
	...
	},
	{
		...
		values: {
			...
			organization_mission_statement: [
				'To alleviate poverty and provide assistance to those in need.',
			],
			organization_start_date: ['2000-05-01'],
			organization_operating_budget: ['$15,000,000'],
			proposal_name: ['Food for All'],
			proposal_summary: [
				'Our proposal aims to establish a community kitchen to provide free meals to homeless individuals in the city.',
			],
	...
	},
	{
		...
		values: {
			...
			organization_website: ['www.example.org'],
			organization_mission_statement: [
				'To promote creativity and innovation through education and the arts.',
			],
			organization_start_date: ['2015-02-01'],
			organization_operating_budget: ['$2,000,000'],
			proposal_name: ['Art for All'],
			proposal_summary: [
				'Our proposal aims to provide art classes and workshops to underserved communities in the city.',
			],
			proposal_amount_requested: ['$50,000'],
	...
	},
	{
		...
		values: {
			...
			organization_website: ['www.example.com'],
			organization_mission_statement: [
				'To promote sustainable living and protect the environment through education and advocacy.',
			],
			organization_start_date: ['2008-01-01'],
			organization_operating_budget: ['$5,000,000'],
			proposal_name: [],
			proposal_summary: [
				'Our proposal aims to collaborate with local government and businesses to make the city more environmentally friendly.',
			],
			proposal_amount_requested: ['$100,000'],
	...
	},
	{
		...
		values: {
			...
			organization_website: ['www.example.com'],
			organization_mission_statement: [
				'To improve the health and wellbeing of children through education, advocacy, and access to healthcare.',
			],
			organization_start_date: ['2010-10-01'],
			organization_operating_budget: ['$3,000,000'],
			proposal_name: ['Healthy School Meals'],
			proposal_summary: [
				'Our proposal aims to provide healthy and nutritious meals to children in schools, while also promoting education about healthy eating habits.',
			],
